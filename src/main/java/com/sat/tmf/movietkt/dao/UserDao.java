...
//    }
    ...
    /**
     * Authenticate user by username and encoded password.
     */
    public User authenticate(String username, String password) {
        // This method is now handled in service layer with password encoding
        // We'll keep it but service will handle the password matching
