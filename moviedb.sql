...
(1, 1, NOW(), 400.00, 'CONFIRMED', NOW() + INTERVAL 1 HOUR),
(2, 3, NOW(), 700.00, 'CONFIRMED', NOW() + INTERVAL 1 HOUR),
(1, 2, NOW(), 550.00, 'HOLD', NOW() + INTERVAL 30 MINUTE);
...
(2, 2, 700.00, 'SUCCESS', 'txn_123457', 'RAZORPAY', NOW()),
(3, 1, 550.00, 'INITIATED', 'txn_123458', 'RAZORPAY', NOW());

-- Refunds
insert into refunds (payment_id, booking_id, user_id, amount, status, refundTxnId, createdAt, processedAt) values
(1, 1, 1, 400.00, 'SUCCESS', 'ref_123456', NOW(), NOW()),
(2, 2, 2, 700.00, 'SUCCESS', 'ref_123457', NOW(), NOW()),
(3, 2, 2, 550.00, 'INITIATED', 'ref_123458', NOW(), NULL);
